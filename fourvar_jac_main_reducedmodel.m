...
% [t u] 	= ode15s(@RHS_fourvar,tspan,u0,options,p);
    ...
    [t,n,te,ye,ie]= ode15s(@RHS_fourvar_reducedmodel,tspan,u0,options,p);% time points as wave crosses each node
%     c           = 1./diff(TE(2:end));                                   % calculate speed
...
%% Figures
figure(5)
plot(x,C(1,:),'linewidth',2,'color','r')
hold on
for i = 20:20
    hold on
    plot(x,C(1*i,:),'linewidth',2,'color','r')
end
set(gca,'fontsize',16)
...
figure(6)
plot(x,F(1,:),'linewidth',2,'color','r')
hold on
for i = 20:20
    hold on
    plot(x,F(1*i,:),'linewidth',2,'color','r')
end
set(gca,'fontsize',16)
xlabel('X','FontSize',18,'FontWeight','bold')
...
figure(7)
plot(x,M(1,:),'linewidth',2,'color','r')
hold on
for i = 20:20
    hold on
    plot(x,M(1*i,:),'linewidth',2,'color','r')
end
set(gca,'fontsize',16)
xlabel('X','FontSize',18,'FontWeight','bold')
...
figure(8)
plot(x,P(1,:),'linewidth',2,'color','r')
hold on
for i = 20:20
    hold on
    plot(x,P(1*i,:),'linewidth',2,'color','r')
end
set(gca,'fontsize',16)
xlabel('X','FontSize',18,'FontWeight','bold')
